...
@section('title', ' تعديل بيانات نوع المورد')
@section('contentheader', 'انواع الموردين ')

@section('contentheaderlink')
    <a href="{{ route('admin.treasuries.index') }}"> انواع الموردين </a>
@endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title card_title_center"> تعديل نوع المورد </h3>
                ...
                <div class="card-body">
                    ...
                    @if (@isset($data) && !@empty($data))
                        <form action="{{ route('admin.supplier_types.update', $data['id']) }}" method="post">
                            @csrf

                            <div class="form-group">
                                <label>اسم نوع المورد</label>
                                <input name="name" value="{{ old('name', $data['name']) }}" id="name"
                                    class="form-control" placeholder="ادخل اسم نوع المورد">
                                @error('name')
