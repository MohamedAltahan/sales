                        ...
                        <form action="{{ route('admin.treasuries.update', $data['id']) }}" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <select name="is_master" id="is_master" class="form-control">
                                    ...
                                    <option value="1" @if (old('is_master') == 1) selected= 'selected' @endif>
                                        نعم
                                    </option>

                                    <option value="0" @if (old('is_master') == 0) selected= 'selected' @endif>لا
                                    </option>
                            ...
                            <div class="form-group">
                                ...
                                <select name="active" id="active" class="form-control">
                                    ...
                                    <option @if (old('active') == 0) selected= 'selected' @endif value="0">
                                        غيرمفعل
                                    </option>
